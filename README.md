...
[![Build Status](https://dev.azure.com/nukeeper/NuKeeper/_apis/build/status/PR%20build?branchName=master)](https://dev.azure.com/nukeeper/NuKeeper/_build/latest?definitionId=3?branchName=master&label=build)
